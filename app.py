...
# MongoDB Setup (will use .env if python-dotenv is installed, otherwise relies on system env)
try:
...
if MONGO_URI and "***********" not in MONGO_URI:
    ...
    print("Warning: MONGODB_URI not set or invalid. Database logging is disabled.")
    ...
    try:
        ...
        if users_collection is not None:
            try:
                ...
                print(f"Saved record for {name} to MongoDB")
